...
public class Tile : GameObject
{
    ...
    public Tile(Type type, SurfaceType surface)
    {
        ...
        if (type == Type.Wall)
            image = new SpriteGameObject("Sprites/Tiles/spr_wall" + surfaceExtension, TickTickGame.Depth_LevelTiles);
        else if (type == Type.Platform)
            image = new SpriteGameObject("Sprites/Tiles/spr_platform" + surfaceExtension, TickTickGame.Depth_LevelTiles);
