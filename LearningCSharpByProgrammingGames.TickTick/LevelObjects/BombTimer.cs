...
public class BombTimer : GameObjectList
{
    ...
    public BombTimer()
    {
        ...
        SpriteGameObject background = new SpriteGameObject("Sprites/UI/spr_timer", TickTickGame.Depth_UIBackground);
        AddChild(background);

        // add a text
        label = new TextGameObject("Fonts/MainFont", TickTickGame.Depth_UIForeground, Color.Yellow, TextGameObject.Alignment.Center);
