using LearningCSharpByProgrammingGames.Engine.Animation;
...
/// </summary>
public class Turtle : AnimatedGameObject
{
    ...
    public Turtle(Level level) : base(TickTickGame.Depth_LevelObjects)
    {
        this.level = level;
    ...
    bool HasSpikesOut { get { return sneezing && sprite.SheetIndex >= 2; } }
}