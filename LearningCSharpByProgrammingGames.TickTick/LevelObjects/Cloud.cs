...
public class Cloud : SpriteGameObject
{
    Level level;

    public Cloud(Level level) : base(null, TickTickGame.Depth_Background)
    {
        this.level = level;
        Reset();
    }
    ...
    void Randomize()
    {
        ...
        float depth = TickTickGame.Depth_Background + (float)ExtendedGame.Random.NextDouble() * 0.2f;
