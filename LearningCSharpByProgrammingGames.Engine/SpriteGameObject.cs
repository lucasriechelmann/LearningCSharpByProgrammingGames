...
public class SpriteGameObject : GameObject
{
    ...
    public bool HasPixelPreciseCollision(Rectangle other)
    {
        ...
        Rectangle b = CollisionDetection.CollisionDetection.CalculateIntersection(BoundingBox, other);
    ...
    {
        // calculate the intersection between the two bounding boxes
        Rectangle b = CollisionDetection.CollisionDetection.CalculateIntersection(BoundingBox, other.BoundingBox);
